...
<html>
	...
	<body>
		...
		<div id="create-game" class="content scaffold-create" role="main">
			<h1 class="tit"><g:message code="default.create.label" args="[entityName]" /></h1>
			...
			<g:form action="save" >
				...
				<fieldset class="buttons">
					<g:submitButton name="create" class="bt save" value="${message(code: 'default.button.create.label', default: 'Create')}" />
				</fieldset>
			</g:form>
		</div>
	</body>
